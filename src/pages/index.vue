<template>
    <div>
        ...
        <main class="page container">
            <div class="panel">
                <div class="header">
                    <router-link class="topic-tab current-tab" :to="{'name':'list',query:{tab:'all'}}">全部</router-link>
                    <router-link class="topic-tab" :to="{'name':'list',query:{tab:'good'}}">精华</router-link>
                    <router-link class="topic-tab" :to="{'name':'list',query:{tab:'share'}}">分享</router-link>
                    <router-link class="topic-tab" :to="{'name':'list',query:{tab:'ask'}}">问答</router-link>
                    <router-link class="topic-tab" :to="{'name':'list',query:{tab:'job'}}">招聘</router-link>
                    <router-link class="topic-tab" :to="{'name':'list',query:{tab:'dev'}}">客户端测试</router-link>
                </div>
